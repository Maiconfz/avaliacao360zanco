...
import com.avaliacao360zanco.service.AvaliacaoModeloService;
import com.avaliacao360zanco.domain.AvaliacaoModelo;
import com.avaliacao360zanco.repository.AvaliacaoModeloRepository;
...
@Service
@Transactional
public class AvaliacaoModeloServiceImpl implements AvaliacaoModeloService{

    private final Logger log = LoggerFactory.getLogger(AvaliacaoModeloServiceImpl.class);
