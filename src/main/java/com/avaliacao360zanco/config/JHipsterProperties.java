...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "avaliacao360Zanco@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "avaliacao360Zanco API";

        private String description = "avaliacao360Zanco API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "avaliacao360Zanco";
