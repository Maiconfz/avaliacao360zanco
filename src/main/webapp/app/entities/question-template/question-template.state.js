(function() {
    ...
    angular.module('avaliacao360ZancoApp').config(stateConfig);

    stateConfig.$inject = [ '$stateProvider' ];

    function stateConfig($stateProvider) {
        $stateProvider.state('question-template', {
            parent : 'entity',
        ...
        }).state('team-evaluation-template-question-templates', {
            parent : 'entity',
            url : '/team/{teamId}/evaluation-template/{etId}/question-templates',
            data : {
            ...
            resolve : {
                ...
                teamFilter : [ '$stateParams', 'Team', function($stateParams, Team) {
                    return Team.get({
                        id : $stateParams.teamId
                    }).$promise;
                } ],
                evaluationTemplateFilter : [ '$stateParams', 'EvaluationTemplate', function($stateParams, EvaluationTemplate) {
            ...
            onEnter : [ '$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    ...
                    $state.go('question-template', null, {
                        reload : 'question-template'
                    });
                }, function() {
