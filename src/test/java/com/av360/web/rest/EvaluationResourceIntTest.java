...
public class EvaluationResourceIntTest {
    ...
    public void setup() {
        ...
        EvaluationResource evaluationResource = new EvaluationResource(evaluationService);
    ...
    public static Evaluation createEntity(EntityManager em) {
        ...
        // Add required entity
        User evaluatedUser = UserResourceIntTest.createEntity(em);
        em.persist(evaluatedUser);
        em.flush();
    ...
    public void checkDescriptionIsRequired() throws Exception {
        int databaseSizeBeforeTest = evaluationRepository.findAll().size();
        // set the field null
        evaluation.setDescription(null);
